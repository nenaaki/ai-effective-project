...
const ITERATION3_DATA = {
  ...
  tasks: [
    ...
    // ───────── ④ 監査ログ・操作履歴 ─────────
    { name: "仕様精査(監査ログ)～PM合意", base: "audit", person: 1, group: "仕様精査", code: "SP4", owner: "両", deps: [], asis: 21.6, plan: 14.4, tobe: 0.10, status: "着手中", progress: 0.01, desc: "記録対象（誰が・いつ・どの画面/APIで・何を・どう変えた）・保持期間・閲覧権限・個人情報の扱いの整理〜PM合意。／9/8分：PW-299 として「見ただけの操作を記録するか」を確認 0.10h（band AI稼働）。" },
