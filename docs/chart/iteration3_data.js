...
const ITERATION3_DATA = {
  ...
  tasks: [
    ...
    { name: "仕様精査(通知基盤)～PM合意", base: "notify", person: 2, group: "仕様精査", code: "SP2", owner: "両", deps: [], asis: 21.6, plan: 14.4, tobe: 1.47, status: "着手中", progress: 0.1, desc: "通知の種別・宛先（ロール／デポ／個人）・チャネル（アプリ内・メール・SMS）・既読管理・再送方針の整理〜PM合意。業務イベントの棚卸しを含む。／9/8分：PW-298 として着手。Google Chat通知詳細（xlsx）の正本取り込み・設計アーティファクト作成・既読の要否の詰め 1.47h（band AI稼働・サブエージェントなし）。" },
    ...
    { name: "予備工数2", base: "reserve", person: 2, group: "予備工数", code: "RS2", owner: "両", deps: [], asis: 20.0, plan: 20.0, tobe: 17.44, status: "着手中", progress: 0.87, desc: "人員2の予備。仕様変更・割り込み・追加調査の吸収枠。／9/1-9/2分 1.55h（band AI稼働）＝PW-287 緯度経度取得APIの方式選定 0.72h（イテレーション3の計画外・主要部分は9/3で次回計上）／コードレビュー・商品マスタのマスク確認など 0.53h／AWS費用（NAT Gateway課金）の確認 0.30h。／9/3-9/10分 15.89h＝夜間ループの直列実装9.52h（PW-268/269/301/302/305/306/307/317＝計画外の割り込み。9/9 00:36-01:42 と 9/9 22:21-9/10 06:07 の経過時間8.87h＋昼の指示・確認の帯0.65h。PW-298/299分も同じ塊に混在）／PW-287 緯度経度・住所分割4.44h／PW-303 SFTP実接続の懸念整理1.59h／レビュー・パスワード取得ほか0.34h。" },
