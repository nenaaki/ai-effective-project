...
> 従来型のアジャイルやスクラムといったプロジェクト形態の場合、1イテレーション( **2weeks** )に1つのフィーチャーをデプロイし、エピックがそろった時に Delivery が可能です。<br />
> spec駆動開発の場合、AIが担当できるフィーチャーは **2-3days** での実装を心掛けます。

spec駆動開発における「納期」は、単なる終了日ではなく、 **「開発サイクル（イテレーション）の速度」** として捉えます。<br />
下記の状態が生じている場合、AIに与えている **spec** の精度が悪い可能性が高いと考えられます。
...
これらについて早期発見と改善を行うことで、開発後半に急激にデリバリーが劣化することを防止する。
